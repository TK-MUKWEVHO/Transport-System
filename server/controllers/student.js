...
export const signin=async(req,res)=>{
    ...
    try {
        ...
        const token =jwt.sign({studentNumber: findStudent.studentNumber,id: findStudent._id},secret,{expireIn:"1h"});
...
export const signup=async(req,res)=>{
    ...
    try {
        ...
        const token =jwt.sign({studentNumber: outCome.studentNumber,id:outCome._id},secret,{expireIn: "1h"});
